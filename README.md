...
The app will let users create a private recipe collection, add structured ingredients, edit recipes over time, and scale quantities to match the desired number of servings.

## Planned Features

- registration, login, and private recipe collections;
- manual recipe creation, editing, and deletion;
- structured ingredients, units, and notes;
