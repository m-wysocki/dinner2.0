...
export default function Index() {
  ...
  const recipesQuery = useQuery({
    ...
    enabled: authenticatedState !== null && isAccessActive(authenticatedState),
  });
  ...
  // Pending-access users land on the Account screen wherever they navigate.
  if (!isAccessActive(authenticatedState)) {
